...
def add_edge():
    ...
    node_props = json.loads(flask.request.form.get('node_props', type=str, default='{}'))
    ...
    edge_id = graph.create_edge(from_node_id, props, to_node_id, to_node_remote, node_props)
